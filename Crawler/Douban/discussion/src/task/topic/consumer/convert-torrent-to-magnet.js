...
function convertTorrentToMagnet (torrentBuf) {
    let torrent = null

    try {
        torrent = parseTorrent(torrentBuf)
        ...
        return [new Error(`Torrent parse failed: ${err.message}`), null]
    }
    ...
    if (torrent && torrent.infoHash) {
        ...
        // https://github.com/webtorrent/magnet-uri#readme
        // {
        //     xt: [
        ...
        return [new Error('Invalid torrent identifier'), null]
    }
}

module.exports = convertTorrentToMagnet
